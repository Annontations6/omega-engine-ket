const game = {
    ...
    achievements: [
        ...
        new Achievement("Layer Of Layer", "Reach layer 1e24", "👍", () => game.metaLayer.layer.gte("1e24")),
        ...
        new Achievement("you win", "or do you?!?!?!!", "<span class='flipped-v'>ඞ</span>", () => game.metaLayer.layer.gte(Infinities[0])),
        new Achievement("Inf-Infinity", "Reach layer 1.8e308", "<span class='flipped-v'>ඞ</span>", () => game.metaLayer.layer.gte(Infinities[0])),
        new Achievement("This?", "10^308 layer?", "👍²", () => game.metaLayer.layer.gte("1.8e308")),
        new Achievement("Starting Out", "Reach 1 α (somehow?)", "αααααααααα", () => game.metaLayer.layer.gte(Infinities[1])),
        new Achievement("Die", "Eee", PrestigeLayer.getNameForLayer("1e1096336"), () => game.metaLayer.layer.gte("1e1096336")),
        new Achievement("Other Times Await", "something's up", "ββββββββββ", () => game.metaLayer.layer.gte(Infinities[2])),
