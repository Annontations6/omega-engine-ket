...
var id = "convergents_to_sqrt(2)_ez"
var name = "Convergents to √2 (EZ)";
...
var authors = "Annontataions6";
var version = 9;
var releaseOrder = "4";
var q = BigNumber.ONE;

var q1, q2, c1, c2, n, c3, q3;
var q1Exp, c2Term, c2Exp;

var init = () => {
    currency = theory.createCurrency();
    currency_capicorn = theory.createCurrency("♑️", "♑️");
    ...
    //c3
    {
        ...
        let getInfo = (level) => "c_2=" + getC2(level).toString(0);
        c3 = theory.createUpgrade(6, currency, new ExponentialCost(1e9, Math.log2(BigNumber.TEN.pow(5.65))));
    ...
    // q3
    {
        ...
        q3 = theory.createUpgrade(7, currency, new FirstFreeCost(new ExponentialCost(10, Math.log2(5))));
        q3.getDescription = (amount) => Utils.getMath(getDesc(q3.level));
...
var tick = (elapsedTime, multiplier) => {
    ...
    currency_capicorn.value += currency.value.pow(0.2)
    ...
    currency.value += bonus * vq1 * vq2 * q * dt * getC3(c3.level) * getQ3(q3.level);
...
var getQ1 = (level) => BigNumber.from(Math.log2(level + 1) + 1)
